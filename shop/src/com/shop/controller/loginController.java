...
public class loginController {
	...
	public String userLogout(HttpServletRequest request,
		...
		response.setHeader("refresh", "5;url=/shop/index.action");//5秒跳转至首页
	...
	public String adminUser_login(HttpServletRequest request,Model model,@RequestParam String username,@RequestParam String password) throws Exception{
		...
		request.getSession().setAttribute("adminuserLogin", adminuserLogin);//session会话全程存在 只要不退出 用以后面判断是否登录
